...
namespace WebSiteBanHang.Controllers
{
    public class QuanLyDonHangController : Controller
    {
        ...
        public ActionResult DuyetDonHang(DonDatHang ddh)
        {
            ...
            // Lưu ý muốn gửi mail thì phải tắt cap cha của gg
            // và phải bật cho phép các ứng dụng kém an toàn
            /*GuiMail("Xác nhận đơn hàng của hệ thống", "nguyenlonghai03@gmail.com","ksshop.com.vn@gmail.com","google123456","Đơn hàng của bạn đã được đặt thành công!");
*/
        ...
        public void GuiMail(string Title, string ToEmail, string FromEmail, string Password, string Content)
        {
            ...
            smtp.Credentials = new System.Net.NetworkCredential(FromEmail, Password); // Tài khoản pass word người gửi
